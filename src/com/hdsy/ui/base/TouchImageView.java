...
public class TouchImageView extends ImageView {
	...
	public TouchImageView(Context context, String url) {
		super(context);
		init();
		SetImage(url);
	}

	private void setRotatable(boolean b) {
		rotatable = b;
	}
	...
	public void SetImage(String url) {
		gintama = Internal.GetBitmap(url,false);
		matrix.postTranslate((widthScreen - gintama.getWidth()) / 2,
				(heightScreen - gintama.getHeight()) / 2);
	}
	...
	private boolean matrixCheck() {
		...
		float w=gintama.getWidth(),h=gintama.getHeight();
		float[] pic_rect={0,0,w,0,w,h,0,h};
		matrix1.mapPoints(pic_rect);
